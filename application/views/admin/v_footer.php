<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">TMVN</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<?php echo base_url();?>assets/admin/<?php echo base_url();?>assets/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url();?>assets/admin/<?php echo base_url();?>assets/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?php echo base_url();?>assets/admin/dist/js/<?php echo base_url();?>assets/admin/pages/dashboard.js"></script>
